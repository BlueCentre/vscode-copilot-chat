...
export class WalkthroughCommandContribution extends Disposable {
	constructor() {
		super();
		this._register(vscode.commands.registerCommand('swe.agent.open.walkthrough', () => {
			vscode.commands.executeCommand('workbench.action.openWalkthrough', { category: 'Vitruvian.agent-chat#copilotWelcome' }, /* toSide */ false);
		}));

		this._register(vscode.commands.registerCommand('swe.agent.mcp.viewContext7', () => {
