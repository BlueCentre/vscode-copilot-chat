...
${message}`,
	...
	const doGenerateTests = (arg?: unknown) => {
		// @ulugbekna: `swe.agent.chat.generateTests` is invoked from editor context menu, which means
	...
	// register commands
	disposables.add(vscode.commands.registerCommand('swe.agent.chat.explain', doExplain));
	disposables.add(vscode.commands.registerCommand('swe.agent.chat.explain.palette', () => doExplain(undefined, true)));
	disposables.add(vscode.commands.registerCommand('swe.agent.chat.review', () => doReview(...instaService.invokeFunction(getServicesForReview), 'selection', vscode.ProgressLocation.Notification)));
	disposables.add(vscode.commands.registerCommand('swe.agent.chat.review.stagedChanges', () => doReview(...instaService.invokeFunction(getServicesForReview), 'index', vscode.ProgressLocation.SourceControl)));
	disposables.add(vscode.commands.registerCommand('swe.agent.chat.review.unstagedChanges', () => doReview(...instaService.invokeFunction(getServicesForReview), 'workingTree', vscode.ProgressLocation.SourceControl)));
	disposables.add(vscode.commands.registerCommand('swe.agent.chat.review.changes', () => doReview(...instaService.invokeFunction(getServicesForReview), 'all', vscode.ProgressLocation.SourceControl)));
	disposables.add(vscode.commands.registerCommand('swe.agent.chat.review.changes.cancel', () => cancelReview(vscode.ProgressLocation.SourceControl, instaService.invokeFunction(accessor => accessor.get(IRunCommandExecutionService)))));
	disposables.add(vscode.commands.registerCommand('swe.agent.chat.review.apply', doApplyReview));
	disposables.add(vscode.commands.registerCommand('swe.agent.chat.review.applyAndNext', (commentThread: vscode.CommentThread) => doApplyReview(commentThread, true)));
	disposables.add(vscode.commands.registerCommand('swe.agent.chat.review.applyShort', (commentThread: vscode.CommentThread) => doApplyReview(commentThread, true)));
	disposables.add(vscode.commands.registerCommand('swe.agent.chat.review.continueInInlineChat', doContinueInInlineChat));
	disposables.add(vscode.commands.registerCommand('swe.agent.chat.review.continueInChat', doContinueInChat));
	disposables.add(vscode.commands.registerCommand('swe.agent.chat.review.discard', doDiscardReview));
	disposables.add(vscode.commands.registerCommand('swe.agent.chat.review.discardAndNext', (commentThread: vscode.CommentThread) => doDiscardReview(commentThread, true)));
	disposables.add(vscode.commands.registerCommand('swe.agent.chat.review.discardShort', (commentThread: vscode.CommentThread) => doDiscardReview(commentThread, true)));
	disposables.add(vscode.commands.registerCommand('swe.agent.chat.review.discardAll', doDiscardAllReview));
	disposables.add(vscode.commands.registerCommand('swe.agent.chat.review.markHelpful', markReviewHelpful));
	disposables.add(vscode.commands.registerCommand('swe.agent.chat.review.markUnhelpful', markReviewUnhelpful));
	disposables.add(vscode.commands.registerCommand('swe.agent.chat.review.previous', thread => goToNextReview(thread, -1)));
	disposables.add(vscode.commands.registerCommand('swe.agent.chat.review.next', thread => goToNextReview(thread, +1)));
	disposables.add(vscode.commands.registerCommand('swe.agent.chat.review.current', thread => goToNextReview(thread, 0)));
	disposables.add(vscode.commands.registerCommand('swe.agent.chat.generate', doGenerate));
	disposables.add(vscode.commands.registerCommand('swe.agent.chat.generateDocs', doGenerateDocs));
	disposables.add(vscode.commands.registerCommand('swe.agent.chat.generateTests', doGenerateTests));
	disposables.add(vscode.commands.registerCommand('swe.agent.chat.fix', doFix));
	disposables.add(vscode.commands.registerCommand('swe.agent.chat.generateAltText', doGenerateAltText));
